...
public class TesteTarifaEstacionamento {
    ...
    public void tarifaFixaPorHora() {
        ...
        int valor = t.valor();
        Assertions.assertEquals(12, valor);
    }
    ...
    public void tarifaDiaria() {
        TarifaEstacionamento t = new TarifaEstacionamento(2, new CalculoDiaria(20));
        int valor = t.valor();
        Assertions.assertEquals(60, valor);
    }
    ...
    public void tarifaDiariaMenorQueUmDia() {
        ...
        int valor = t.valor();
        Assertions.assertEquals(20, valor);
    }
}
